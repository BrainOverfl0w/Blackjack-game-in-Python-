...
# Creating card classs for card objects 
class Card:
...
# Function prompting the player to hit o stand 
...
# Funtions to handle end of game scenarios 
...
while True:
    ...
    while playing: 
        ...
        # Showing cards (but keep one dealer card hidden)
        show_some(player_hand,dealer_hand)  
    ...
    if player_hand.value <= 21:
        ...
        # Runnin different winning scenarios
